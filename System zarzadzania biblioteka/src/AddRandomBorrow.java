 ...
 * @author Bogdan
 */
public class AddRandomBorrow extends javax.swing.JFrame {
    Connection conn;
    ResultSet res;
    PreparedStatement cst;
    /**
     * Creates new form AddRandomBorrow
     */
    public AddRandomBorrow() {
        super("Add Random Borrow");
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Dodaj losowe wypożyczenie");
        setResizable(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(TF_user, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            try{
                ...
                UserFrame.TF_user.setText(AddBorrow.TF_user.getText());
                ob.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddRandomBorrow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddRandomBorrow().setVisible(true);
            }
        });
    }
