 ...
 * @author Bogdan
 */
public class PublishingSupply extends javax.swing.JFrame {
    Connection conn;
    ResultSet res;
    PreparedStatement pst;
    CallableStatement cst;
    /**
     * Creates new form PublishingSupply
     */
    public PublishingSupply() {
        super("Publishing Supply");
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        setVisible(false);
        Books ob = new Books();
        Books.TF_user.setText(PublishingSupply.TF_user.getText());
        ob.setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String sql = "{call dostawa_towaru(?,?)}";
        try{
            ...
            try{
                ...
                UserFrame.TF_user.setText(PublishingSupply.TF_user.getText());
                ob.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PublishingSupply.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PublishingSupply().setVisible(true);
            }
        });
    }
